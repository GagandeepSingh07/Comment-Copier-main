                            ...
                            setTimeout(async () => {
                                ...
                                try {
                                    ...
                                    console.log('SMOKE main-courses:', await mainWindow.webContents.executeJavaScript(`JSON.stringify({
                                        ...
                                        copyTabs: document.querySelectorAll('#mw-course-list .mw-course-item')[0] ? document.querySelectorAll('#mw-course-list .mw-course-item .mw-course-field').length : 0,
                                        ...
                                        firstTabs: Array.from(document.querySelectorAll('#mw-course-list .mw-course-item'))[0] ? Array.from(document.querySelectorAll('#mw-course-list .mw-course-item')[0].querySelectorAll('.mw-course-field')).map(t => ({ label: t.querySelector('.mw-course-field-label') ? t.querySelector('.mw-course-field-label').textContent : '', value: t.querySelector('.mw-course-field-value') ? t.querySelector('.mw-course-field-value').textContent : '' })) : [],
                                        header: Array.from(document.querySelectorAll('#mw-course-list .mw-course-item')).map(x => ({ title: x.querySelector('.mw-course-item-title') ? x.querySelector('.mw-course-item-title').textContent : '', trainer: x.querySelector('.mw-course-item-trainer') ? x.querySelector('.mw-course-item-trainer').textContent : '', code: x.querySelector('.mw-course-item-code') ? x.querySelector('.mw-course-item-code').textContent : '' })),
                                    })`));

                                    if (process.env.SMOKE_PROBE) {
                                        const recap = await mainWindow.webContents.executeJavaScript(`JSON.stringify({
                                            header: Array.from(document.querySelectorAll('#mw-course-list .mw-course-item')).map(x => ({ title: x.querySelector('.mw-course-item-title') ? x.querySelector('.mw-course-item-title').textContent : '', trainer: x.querySelector('.mw-course-item-trainer') ? x.querySelector('.mw-course-item-trainer').textContent : '', code: x.querySelector('.mw-course-item-code') ? x.querySelector('.mw-course-item-code').textContent : '' })),
                                            mi: Array.from(document.querySelectorAll('#mw-course-list .mw-course-item'))[0] ? Array.from(document.querySelectorAll('#mw-course-list .mw-course-item')[0].querySelectorAll('.mw-course-field')).map(t => (t.querySelector('.mw-course-field-label') ? t.querySelector('.mw-course-field-label').textContent : '') + '=' + (t.querySelector('.mw-course-field-value') ? t.querySelector('.mw-course-field-value').textContent : '')) : [],
                                        })`);
